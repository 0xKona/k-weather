  ...
  return (
    <AnimatePresence>
      <motion.p
        key={localTime}
        aria-hidden="true"
        className="pointer-events-none select-none text-sm md:text-base font-semibold uppercase tracking-[0.3em] text-foreground/60 drop-shadow-[0_1px_6px_rgba(0,0,0,0.9)]"
